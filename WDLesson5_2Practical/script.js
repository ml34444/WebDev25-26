...
3) Create an appropriate random price to display for each pizza
4) Enter quantity is a text input
5) Buy is a button input
...
function init(){
   price = Math.floor(Math.random() * (35-15+1)+15);
